...
public class UserServiceTest {
	...
	public void setUp() {
		...
		exampleId = 1;
		exampleAccessToken = "eyJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiQUNDRVNTIiwic3ViIjoiOSIsImlhdCI6MTc4NTYwNzAxMiwiZXhwIjoxNzg1NjA3OTEyfQ.4CP0udSjKeRa6OyL8C2DKtF6xJlB5C0EiO9i6uWh_IU";
		exampleRefreshToken = "eyJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiUkVGUkVTSCIsInN1YiI6IjkiLCJpYXQiOjE3ODU2MDcwMTIsImV4cCI6MTc4NjIxMTgxMn0.YmBwDEhwNG_xkFXkZoGSlkUQUqqaQoxAsSCDfIAVeyI";
	}
	...
	public void createUser_shouldThrowDuplicateUserException_whenEmailExists() {
		User duplicatedUser = new User(exampleId, "john5", exampleEmail, examplePasswordHash, new ArrayList<Group>());
		RegisterRequest registerRequest = new RegisterRequest(exampleEmail, exampleUsername, examplePassword);
